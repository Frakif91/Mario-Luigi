...
class RPG_System:
	enum combat_turn {
		PLAYER_CHOOSING, PLAYER_MENU, PLAYER_SELECTING, PLAYER_ACTION,
		ENEMY_TELEGRAPH,  # L'ennemi charge son attaque, avant le check de défense (TODO)
		PLAYER_DEFENDING, # Fenêtre de timing où le joueur peut défendre (TODO)
		ENEMY_ACTION,
		INTERRUPTION
	}
